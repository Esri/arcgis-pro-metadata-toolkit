...
namespace ArcGIS.Desktop.Metadata.Editor.Pages
{
  internal class ContactManagerSidebarLabel : ISidebarLabel
  {
    ...
    {
      get { return Internal.Metadata.Properties.Resources.CFG_LBL_CONTACT_MGR; }
    }    
  }
  /// <summary>
  /// Interaction logic for ContactManager.xaml
  /// </summary>
  internal partial class ContactManager : EditorPage
  {
    ...
    public void OnUnCheck(object sender, RoutedEventArgs e)
    {
      ...
      if (false == check && "external".Equals(tagNode.InnerText))
      {
        ...
        // show dialog
        MessageBoxResult result = ArcGIS.Desktop.Internal.Framework.DialogManager.ShowMessageBox(Internal.Metadata.Properties.Resources.LBL_CM_Confirm, Internal.Metadata.Properties.Resources.LBL_CM_ConfirmTitle, button, icon);
    ...
    private void ReloadContacts()
    {
      ...
      // come find me later...
      Utils.GetMetadataEditorViewModel(this).AddCommitPage(this);
    }
