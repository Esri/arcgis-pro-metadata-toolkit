...
namespace ArcGIS.Desktop.Metadata.Editor.Pages
{
  ...
  /// </summary>
  internal partial class PartyPickerControl : EditorPage
  {
    ...
    public void LoadList(object sender, EventArgs e)
    {
      ...
      foreach (XmlNode node in list)
      {
        ...
        var nameString = Utils.ExtractResponsiblePartyLabel(node, Internal.Metadata.Properties.Resources.LBL_CI_PARTY_ADD_FORMAT);
