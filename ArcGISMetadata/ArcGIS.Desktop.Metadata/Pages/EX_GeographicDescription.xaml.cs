...
namespace ArcGIS.Desktop.Metadata.Editor.Pages
{
  ...
  /// </summary>
  internal partial class EX_GeographicDescription : EditorPage
  {
    ...
    public override string DefaultValue
    {
      get
      {
        ...
        if (0 < sb.Length)
          return Internal.Metadata.Properties.Resources.LBL_EXTENTS_GEODESC + sb.ToString().Substring(0, 30) + "...";
        else
