      ...
      while (propertyEnumerator.MoveNext())
      {
        switch ((string)propertyEnumerator.Key)
        {
          ...
          case "font-size":
            ...
            string v = (string)propertyEnumerator.Value;
            if (0 < v.IndexOf("pt"))
              v = v.Replace("pt", "");
            xamlElement.SetAttribute(Xaml_FontSize, v);
            break;
          case "color":
          ...
          case "text-align":
            if (isBlock)
            {
              ...
              {
                string align = (string)propertyEnumerator.Value;
                if (align.Equals("left", StringComparison.CurrentCultureIgnoreCase))
                  xamlElement.SetAttribute(Xaml_TextAlignment, "Right");
                else if (align.Equals("right", StringComparison.CurrentCultureIgnoreCase))
    ...
    private static Hashtable GetElementProperties(XmlElement htmlElement, Hashtable inheritedProperties, out Hashtable localProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
    {
      ...
      switch (elementName)
      {
        ...
        case "font":
          ...
          break;
        case "samp":
          localProperties["font-family"] = "monospace"; // code sample
        ...
        case "div":
          ...
          break;
        case "pre":
          localProperties["font-family"] = "monospace"; // renders text in a fixed-width font
          //localProperties["font-size"] = Xaml_FontSize_XXSmall;
          localProperties["text-align"] = "Left";
          break;
        case "blockquote":
