...
namespace ArcGIS.Desktop.Metadata.Editor.Controls
{
    ...
    {
      get { return (bool)GetValue(IsGripEnabledProperty); }
    ...
    {
      get { return (bool)GetValue(IsGripVisibleProperty); }
    ...
    {
      get { return (bool)GetValue(IsAutoSizeEnabledProperty); }
      set { SetValue(IsAutoSizeEnabledProperty, value); }
    }
    ...
    {
      get { return (ResizeDirection)GetValue(ResizeDirectionProperty); }
    ...
    {
      get { return _startResizeCommand; }
    }
    ...
    //}
      ...
      //resizer._resizeOrigin = resizer._frameworkElement.PointToScreen(Mouse.GetPosition(Application.Current.MainWindow));
			//resizer._originalWidth = resizer.ActualWidth;
      if (0 == resizer._originalHeight)
			  resizer._originalHeight = resizer.ActualHeight;
      resizer._currentHeight = resizer.ActualHeight;
        ...
        //Point point = resizer._frameworkElement.PointToScreen(Mouse.GetPosition(Application.Current.MainWindow));
				//double widthDelta = 0;
        ...
        resizer.Height = Math.Max(resizer._originalHeight, resizer._currentHeight + heightDelta);
			}
        ...
        resizer.Height = resizer._originalHeight;
				e.Handled = true;
			}
		}
	}
